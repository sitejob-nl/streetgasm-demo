                                ...
                                {pendingApprovals.map((approval) => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            padding: '16px',
                                            borderRadius: '12px',
                                            background: selectedMember?.id === approval.id
                                                ? 'rgba(251, 191, 36, 0.1)'
                                                : 'rgba(0,0,0,0.2)',
                                            border: selectedMember?.id === approval.id
                                ...
                                <>
                                    ...
                                    <div style={{ marginBottom: '24px' }}>
                                        ...
                                        <div style={{ fontSize: '20px', fontWeight: 700 }}>
                                            #{selectedMember.woocommerce_customer_id}
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'flex', gap: '12px', marginTop: '32px' }}>
                                        <button
                                            ...
                                            onClick={() => approveMutation.mutate({
                                                id: selectedMember.woocommerce_customer_id,
                                                status: 'approved'
                                            })}
